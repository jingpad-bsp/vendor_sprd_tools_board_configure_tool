#!/bin/bash
echo 'in sharkle'
source_str_gofu=${source_str/_go/}_gofu
target_str_gofu=${target_str/_go/}_gofu
source_compatible=${source_str/_go/}  #only for compatible in dts
target_compatible=${target_str/_go/}  #only for compatible in dts

list_name="$source_str:$target_str \
           $SOURCE_STR:$TARGET_STR \
           ${source_str//_/-}:${target_str//_/-} \
           ${SOURCE_STR//_/-}:${TARGET_STR//_/-} \
           ${source_str/_go/}_32b:${target_str/_go/}_32b \
           ${SOURCE_STR/_GO/}_32B:${TARGET_STR/_GO/}_32B \
           ${source_str_gofu}:${target_str_gofu} \
           ${source_str_gofu//_/-}:${target_str_gofu//_/-} \
           ${source_compatible//_/-}:${target_compatible//_/-} "
...
echo '---- add products to AndroidProducts.mk ----'
...
echo "Step 3: create bsp/device/$soc"
...
echo "Step 4: create kernel and dts"
...
echo "Step 5: create uboot board"
uboot_source=${source_str/_go/}_32b
uboot_target=${target_str/_go/}_32b
# copy&rename
...
echo "Step 6: create chipram board"
chipram_source=${source_str/_go/}_32b
chipram_target=${target_str/_go/}_32b
